...
describe("SOL Formatter Tests", () => {
    ...
    let fixturesPath;
    beforeAll(() => {
        formatter = new SolFormatter_1.SolFormatter();
  ...
  - id: TestVision
    ...
    describe("Structure Validation", () => {
        ...
        test("should detect missing SOL header", () => {
            ...
            expect(validation.errors).toContain("Missing SOL header: # SOL - Semantic Operations Language");
        });
  ...
  - id: TestProcess
    ...
    describe("Custom Jest Matchers Integration", () => {
        test("should use custom SOL validation matchers", () => {
            ...
            const invalidDocument = setup_1.TestUtils.createInvalidSOLDocument();
...
Process:
  - id: MainProcess
    ...
    description: "Main business process"`;
            ...
            const artifactIds = setup_1.TestUtils.extractArtifactIds(result);
    ...
    actors:
      - BusinessUser`;
        ...
        test("should validate SOL naming conventions", () => {
            const document = setup_1.TestUtils.createMinimalSOLDocument();
            const result = formatter.formatDocument(document);
            expect(setup_1.TestUtils.hasValidSOLNaming(result)).toBe(true);
        });
    });
});
//# sourceMappingURL=SolFormatter.test.js.map