'use strict';
/* build-hook-start *//*00001*/try { require('/Users/randygala/.cursor/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').default({tool: 'jest', checkSum: '20462ae88c1fa110505e1bBg8cVksIAgcJUgUJUAgEAQVUCQEA', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/randygala/.cursor/extensions/wallabyjs.console-ninja-1.0.453/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20462ae88c1fa110505e1bBg8cVksIAgcJUgUJUAgEAQVUCQEA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
